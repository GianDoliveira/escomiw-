...
function ProjetoPai() {
    return (
        <>
            <section id="projetopai" className="w-screen h-screen relative top-11 flex flex-col justify-center items-center">
                <h1 className="text-center text-4xl mb-4 font-bold text-[#080451]">PAI - PROGRAMA DE APADRINHAMENTO INFANTIL</h1>
            ...
            <section className="w-screen flex relative bottom-14 justify-center items-center">
                <div className="flex flex-col">
                    <h1 className="text-center text-4xl mb-4 font-bold text-[#080451]">PROJETO PAI – COMO TUDO COMEÇOU?</h1>
