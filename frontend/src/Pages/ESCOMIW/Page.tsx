    ...
    return (
        <>
            <section id='escomiw' className="w-screen h-screen relative top-20 flex flex-col justify-center items-center ">
                <h1 className="text-center text-4xl lg:text-5xl font-bold mb-10 text-[#080451]">HISTÓRICO ESCOMIW</h1>
                <div className="lg:w-1/2 h-96 px-20 py-5 lg:py-10 overflow-auto lg:border border-gray-400">
                    <p className="py-5 max-lg:text-2xl">Muito tempo atrás, em Vitória – ES, teve na Igreja Metodista Wesleyana início a um
                    ...
                    <p className="py-5 max-lg:text-2xl">Foi de fato um avivamento espiritual para aqueles dias. Viviam ali em forma de comunidade
                        e totalmente pela fé. A tônica era evangelismo; discipulado e oração. Logo, logo a coisa
                        tomou proporções maiores.</p>
                    <p className="py-5 max-lg:text-2xl">Durante muito tempo esse trabalho deixou de existir. E assim ficou até que certa feita,
                    ...
                    <p className="py-5 max-lg:text-2xl">De pronto, a Escomiw tomou a iniciativa de formar caravanas que abençoariam o Campo
                        Missionário do Nordeste por longos anos.

                    </p>
                    <p className="py-5 max-lg:text-2xl">Em 2003, tendo sido eleito secretário regional de missões, na 1ª Região Eclesiástica, o
                    ...
                    <p className="py-5 max-lg:text-2xl">A Escomiw é um braço de interação para os chamados membros leigos da Igreja; uma
                    ...
                    <p className="py-5 max-lg:text-2xl">No ano de 2010, por ocasião do Congresso Geral de Missões, a Escomiw passa a ser
                    ...
                    <p className="py-5 max-lg:text-2xl">Muito mais que ir às Regiões e apenas pulverizar as bases de funcionamento da
                    ...
                    <p className="py-5 max-lg:text-2xl">A partir daí, formar-se a Coordenação Regional da Escomiw.</p>
                    <p className="py-5 max-lg:text-2xl">Passaram por esta fase desde então como Coordenadores da ESCOMIW, Pr Marcos
                    ...
                    <p className="py-5 max-lg:text-2xl">Diante da mesma visão de promover a evangelização, estamos com as lideranças
                    ...
                    <p className="py-5 max-lg:text-2xl">A coordenação Geral tem seus projetos anuais, e cada região os seus projetos
                        específicos.</p>
                    <p className="py-5 max-lg:text-2xl">Conheça um pouco mais dos projetos da Escomiw na 1ª Região Eclesiástica.</p>
                </div>
            </section>
