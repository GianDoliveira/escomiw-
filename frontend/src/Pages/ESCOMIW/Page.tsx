        ...
        <>
            <section className="w-screen h-screen relative top-20 flex flex-col justify-center items-center ">
                ...
                <div className="lg:w-1/2 h-96 px-20 py-5 lg:py-10 overflow-auto lg:border border-gray-400">
                    ...
                    <p className="py-5 max-lg:text-3xl">Foi de fato um avivamento espiritual para aqueles dias. Viviam ali em forma de comunidade
                        e totalmente pela fé. A tônica era evangelismo; discipulado e oração. Logo, logo a coisa
                        tomou proporções maiores.</p>
                    <p className="py-5 max-lg:text-3xl">Durante muito tempo esse trabalho deixou de existir. E assim ficou até que certa feita,
                    ...
                    <p className="py-5 max-lg:text-3xl">De pronto, a Escomiw tomou a iniciativa de formar caravanas que abençoariam o Campo
                        Missionário do Nordeste por longos anos.

                    </p>
                    <p className="py-5 max-lg:text-3xl">Em 2003, tendo sido eleito secretário regional de missões, na 1ª Região Eclesiástica, o
                    ...
                    <p className="py-5 max-lg:text-3xl">A Escomiw é um braço de interação para os chamados membros leigos da Igreja; uma
                    ...
                    <p className="py-5 max-lg:text-3xl">No ano de 2010, por ocasião do Congresso Geral de Missões, a Escomiw passa a ser
                    ...
                    <p className="py-5 max-lg:text-3xl">Muito mais que ir às Regiões e apenas pulverizar as bases de funcionamento da
                    ...
                    <p className="py-5 max-lg:text-3xl">A partir daí, formar-se a Coordenação Regional da Escomiw.</p>
                    <p className="py-5 max-lg:text-3xl">Passaram por esta fase desde então como Coordenadores da ESCOMIW, Pr Marcos
                    ...
                    <p className="py-5 max-lg:text-3xl">Diante da mesma visão de promover a evangelização, estamos com as lideranças
                    ...
                    <p className="py-5 max-lg:text-3xl">A coordenação Geral tem seus projetos anuais, e cada região os seus projetos
                        específicos.</p>
                    <p className="py-5 max-lg:text-3xl">Conheça um pouco mais dos projetos da Escomiw na 1ª Região Eclesiástica.</p>
                </div>
            </section>
